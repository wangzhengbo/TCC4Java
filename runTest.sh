...
CLASSPATH=./lib/commons-io-2.4.jar:./lib/hamcrest-core-1.3.jar:./lib/junit-4.11.jar:./lib/slf4j-api-1.7.7.jar:./lib/slf4j-simple-1.7.7.jar:./dist/TCC4Java-0.1.jar:./dist/TCC4Java-0.1-test.jar
